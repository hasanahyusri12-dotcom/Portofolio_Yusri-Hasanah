  ...
  return (
    <section
      style={{
        maxWidth: 1160,
        margin: "0 auto",
        padding: "0 clamp(16px, 4vw, 24px) clamp(48px, 8vw, 96px)",
      }}
    >
      <Reveal>
      ...
      >
        {/* Left: Photo + identity */}
        <Reveal>
          <Card hover accent accentColor="var(--terracotta)" style={{ overflow: "hidden", borderRadius: 20 }}>
            <div
              style={{
                position: "relative",
                aspectRatio: "4 / 5",
        ...
        <Reveal delay={0.1}>
          <Card hover accent accentColor="var(--terracotta)" style={{ padding: "clamp(20px, 4vw, 32px) clamp(18px, 4vw, 28px)", height: "100%", borderRadius: 20 }}>
