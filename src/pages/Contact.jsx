...
import { Mail, MapPin, Github, Linkedin, Loader2, CheckCircle2, AlertCircle, Copy, MessageCircle, Send } from "lucide-react";
...
const topicOptions = ["Peluang Kerja / Magang Frontend", "Pengembangan Proyek Web / React", "Tawaran Kolaborasi Full-Stack", "Pertanyaan Umum"];
...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!WEB3FORMS_ACCESS_KEY || WEB3FORMS_ACCESS_KEY.startsWith("GANTI_")) {
      ...
      window.location.href = `mailto:${TARGET_EMAIL}?subject=${encodeURIComponent(form.subject || "Pesan dari Portofolio")}&body=${body}`;
      return;
    }
      ...
      >
        ...
        <Reveal>
          <div>
            ...
            >
              Saat ini saya terbuka untuk kesempatan sebagai <strong>Junior Frontend Developer</strong>, Frontend Developer Intern, Junior Web Developer, atau Manual QA Tester. Jangan ragu untuk menghubungi saya melalui WhatsApp atau form
              di bawah ini.
            </p>{" "}
            ...
            <div>
              <span style={{ fontSize: 11.5, fontFamily: fontMono, color: "var(--text-faint)", display: "block", marginBottom: 8 }}>Tautan Profil Sesuai CV:</span>
        ...
        <Reveal delay={0.12}>
          <Card hover={false} accentColor="var(--terracotta)" style={{ padding: "clamp(20px, 4vw, 32px)", borderRadius: 20 }}>
            <h3
              style={{
                fontFamily: fontDisplay,
                fontSize: 19,
            ...
            <p style={{ fontSize: 13, color: "var(--text-secondary)", marginBottom: 18 }}>Pesan akan otomatis diteruskan ke email {TARGET_EMAIL}.</p>

            {/* Quick Topic Chips */}
            <div style={{ marginBottom: 18 }}>
              <label style={{ display: "block", fontSize: 11.5, color: "var(--text-primary)", marginBottom: 8, fontWeight: 600, fontFamily: fontMono }}>Pilih Topik Pesan:</label>
            ...
            <form onSubmit={handleSubmit}>
              <div style={{ marginBottom: 14 }}>
                <label style={{ display: "block", fontSize: 12, color: "var(--text-primary)", marginBottom: 4, fontWeight: 600 }}>Nama Lengkap *</label>
                <input
                  type="text"
              ...
              <div style={{ marginBottom: 14 }}>
                <label style={{ display: "block", fontSize: 12, color: "var(--text-primary)", marginBottom: 4, fontWeight: 600 }}>Alamat Email *</label>
                <input
                  type="email"
              ...
              <div style={{ marginBottom: 14 }}>
                <label style={{ display: "block", fontSize: 12, color: "var(--text-primary)", marginBottom: 4, fontWeight: 600 }}>Subjek / Topik</label>
                <input
                  type="text"
              ...
              <div style={{ marginBottom: 18 }}>
                <label style={{ display: "block", fontSize: 12, color: "var(--text-primary)", marginBottom: 4, fontWeight: 600 }}>Isi Pesan *</label>
                <textarea
